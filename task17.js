...
while (guestsArray.length > 2) {
    var removesguest = guestsArray.pop();
    console.log("\nsorry ".concat(removesguest, "\" \" We can't invite you to dinner"));
}
guestsArray.map(function (items) { return console.log("".concat(items, " you are invited")); });
guestsArray.pop();
guestsArray.pop();
console.log(guestsArray);
